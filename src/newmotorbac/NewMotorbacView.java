 ...
 */
public class NewMotorbacView extends FrameView implements ActionListener {

    // recently opened policies persistence
    private Preferences mruPersistence = Preferences.userNodeForPackage(getClass());
    ...
    private void initComponents() {
        ...
        jButtonExport.setAction(actionMap.get("ExportPolicy")); // NOI18N
        ...
        jButtonExport.setMaximumSize(new java.awt.Dimension(34, 34));
        jButtonExport.setMinimumSize(new java.awt.Dimension(34, 34));
        jButtonExport.setName("jButtonExport"); // NOI18N
        jButtonExport.setPreferredSize(new java.awt.Dimension(34, 34));
        jButtonExport.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
        jToolBarControls.add(jButtonExport);
        ...
        mainPanelLayout.setVerticalGroup(
            mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jToolBarControls, javax.swing.GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
            .addComponent(jTabbedPanePolicies, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 528, Short.MAX_VALUE)
        );
        ...
        jMenuRecentPolicies.setText(resourceMap.getString("jMenuRecentPolicies.text")); // NOI18N
        jMenuRecentPolicies.setName("jMenuRecentPolicies"); // NOI18N
        fileMenu.add(jMenuRecentPolicies);
        ...
        jMenuItemExport.setAction(actionMap.get("ExportPolicy")); // NOI18N
        ...
        jMenuItemExport.setText(resourceMap.getString("jMenuItemExport.text")); // NOI18N
        ...
        jMenuItemProperties.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_P, java.awt.event.InputEvent.CTRL_MASK));
        ...
        jMenuItemOnlineManual.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_M, java.awt.event.InputEvent.ALT_MASK));
    ...
    private void SetPolicyStateReleatedButtonsStates(boolean state) {
        ...
        jButtonExport.setEnabled(state);
        ...
        jMenuItemExport.setEnabled(state);
    }
    ...
    private javax.swing.JMenu jMenuRecentPolicies;
