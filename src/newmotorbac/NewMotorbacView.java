...
public class NewMotorbacView extends FrameView {
    ...
    public void RefreshToolbar(PanelPolicy selectedPolicyTab)
    {
        ...
        String infoText = "";
    	if ( abstractConflictNumber < 0 ) infoText += "abstract conflicts: NA";
    	else infoText += abstractConflictNumber + " abstract conflict" + ((abstractConflictNumber > 1) ? "s" : "");
    	if ( concreteConflictNumber < 0 ) infoText += " | concrete conflicts: NA";
    	else infoText += " | " + concreteConflictNumber + " concrete conflict" + ((concreteConflictNumber > 1) ? "s" : "");
    ...
    public void createPolicy() {
        ...
        if ( newPolicyDialogBox.canceled ) return;
    ...
    public void openPolicy() {
        ...
        // get the result of the file chooser
        if ( chooser.showOpenDialog(getFrame()) == JFileChooser.CANCEL_OPTION ) return;
        // get the selected file
        File file = chooser.getSelectedFile();
